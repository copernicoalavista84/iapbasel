...
<div class="contentcenbg">
    <table cellpadding="3" cellspacing="3" border="0" width="100%">
        ...
        <tr><td align="left" colspan="2" valign="middle" style="padding:5px 0;"><strong>Category :</strong> <?php echo utf8_encode($cat['category']); ?></td></tr>
    </table>		
	<?php	
            ...
            var chart;
                $(document).ready(function() {
                    chart = new Highcharts.Chart({
                        ...
                        xAxis: {
                            categories: ['<?php echo utf8_encode($var); ?>']
                        },
                        yAxis: {
                            min: 0,
                            title: {
       ...
       echo "<TR><th align='center' valign='middle' width='30'>#</th><th align='left' valign='middle'>Question</th><th align='left' valign='middle'>Type</th><th align='center' valign='middle'>Max. Avg. Score</th><th align='center' valign='middle'>Avg. Score</th></tr>";
		if($uc>0){
			...
			while($qus = mysql_fetch_array($questions)){
				...
				echo "<tr><td align='center' valign='middle'>$i</td><td align='left' valign='middle'>".utf8_encode($qus[question])."</td><td align='left' valign='middle'>$qus[type]</td><td align='center' valign='middle'>$qus[max]</td><td align='center' valign='middle'>$qus[avg]</td></tr>";
				$i++;
			}
		}
