...
<body>
    <div class="wrapper">
        <img src="images/IAP-BASEL.jpg" style="padding:5px 0 5px 10px;width:35%;padding:30px 0;">
        <div style="position:absolute;top:5px;right:50px">
        <?php if(basename($_SERVER['PHP_SELF'])=='writetest.php'){
			 if($test['logo']=='') echo '<img src="images/no_preview.jpg" alt="logo" title="logo" width="100" height="100" />';
            else echo '<img src="files/'.$test['logo'].'" alt="logo" title="logo" width="100" height="100" />';
		}?>
		</div>