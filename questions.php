...
<div class="contentcenbg">
    <table cellpadding="3" cellspacing="3" border="0" width="100%">
        ...
        <tr><td align="left" valign="middle" colspan="2" style="padding:10px 0;"><strong style="font-size:16px;font-style:italic;text-decoration:underline;"><?php echo utf8_encode($test['testname']); ?></strong></td>        </tr>
    ...
    <?php
		...
		if($uc>0){
			...
			while($cate = mysql_fetch_array($tests)){
				...
				if($assign>0)
				echo "<tr><td align='center' valign='middle'>$i</td><td align='left' valign='middle'>".utf8_encode($cate[category])."</td><td align='left' valign='middle'>Edit | Delete</td></tr>";
				else
				echo "<tr><td align='center' valign='middle'>$i</td><td align='left' valign='middle'>".utf8_encode($cate[category])."</td><td align='left' valign='middle'><a href='questions.php?test=$test[key]&editcate=$cate[key]'>Edit</a> | <a class='confirdel' href='questions.php?test=$test[key]&delete=$cate[key]'>Delete</a></td></tr>";
				$i++;
			}
		}
    ...
    <?php
		...
		if($uc>0){
			...
			while($qus = mysql_fetch_array($questions)){
				...
				if($assign>0){
				if($qus[type]=='Text')
				echo "<tr><td align='center' valign='middle'>$qus[pos]</td><td align='left' valign='middle'>".utf8_encode($qus[question])."</td><td align='left' valign='middle'>$qus[type]</td><td align='left' valign='middle'>$cat[category]</td><td align='left' valign='middle'>Edit | Delete</td></tr>";
				else
				echo "<tr><td align='center' valign='middle'>$qus[pos]</td><td align='left' valign='middle'>".utf8_encode($qus[question])."</td><td align='left' valign='middle'>$qus[type]</td><td align='left' valign='middle'></td><td align='left' valign='middle'>Edit | Delete</td></tr>";
				}
				else{
				if($qus[type]=='Text')
				echo "<tr><td align='center' valign='middle'><input type='hidden' id='qid' name='data[qus][$i][qid]' value='$qus[qid]'><input type='text' id='pos' class='savetxt' name='data[qus][$i][pos]' value='$qus[pos]'></td><td align='left' valign='middle'>".utf8_encode($qus[question])."</td><td align='left' valign='middle'>$qus[type]</td><td align='left' valign='middle'>".$abc."</td><td align='left' valign='middle'><a href='textquestion.php?test=$test[key]&editqus=$qus[key]'>Edit</a> | <a class='confirdel' href='textquestion.php?test=$test[key]&delete=$qus[key]'>Delete</a></td></tr>";
				else
				echo "<tr><td align='center' valign='middle'><input type='hidden' id='qid' name='data[qus][$i][qid]' value='$qus[qid]'><input type='text' id='pos' class='savetxt' name='data[qus][$i][pos]' value='$qus[pos]'></td><td align='left' valign='middle'>".utf8_encode($qus[question])."</td><td align='left' valign='middle'>$qus[type]</td><td align='left' valign='middle'>".$abc."</td><td align='left' valign='middle'><a href='mcquestion.php?test=$test[key]&editqus=$qus[key]'>Edit</a> | <a class='confirdel' href='mcquestion.php?test=$test[key]&delete=$qus[key]'>Delete</a></td></tr>";
				}
				$abc = "";
				$i++;
			}
