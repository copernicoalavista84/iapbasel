        ...
        <table cellpadding="3" cellspacing="3" border="0" align="center">
            <tr>
            	...
            	<td align="left" valign="middle">
					...
					echo "<option value='$foo[cid]'>".utf8_decode($foo[category])."</option>";
					} ?>
                    </select>
                </td>
            </tr>
    ...
    <form action="" method="post" enctype="multipart/form-data" id="myForm">
        <table cellpadding="3" cellspacing="3" border="0" align="center">
            ...
            <tr>
            	<td align="right" valign="middle">Choice <?php echo $x; ?>:</td>
            	<td align="left" valign="middle">
                	<input type="text" <?php if($x<3) echo 'class="validate[required]"'; ?> style="width:300px;" id="option<?php echo $x; ?>" value="<?php echo utf8_encode($opt['option'.$x]);?>" name="option<?php echo $x; ?>">
                	Weight :&nbsp;&nbsp;
                	<select id="weight<?php echo $x; ?>" name="weight<?php echo $x; ?>">
                    <?php 
					for($k=0; $k<11; $k++){ 
