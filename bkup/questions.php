    ...
    <?php
		...
		if($uc>0){
			...
			while($qus = mysql_fetch_array($questions)){
				...
				if($qus[type]=='Text')
				echo "<tr><td align='center' valign='middle'><input type='hidden' id='qid' name='data[qus][$i][qid]' value='$qus[qid]'><input type='text' id='pos' class='savetxt' name='data[qus][$i][pos]' value='$qus[pos]'></td><td align='left' valign='middle'>$qus[question]</td><td align='left' valign='middle'>$qus[type]</td><td align='left' valign='middle'>$cat[category]</td><td align='left' valign='middle'><a href='textquestion.php?test=$test[key]&editqus=$qus[key]'>Edit</a> | <a class='confirdel' href='textquestion.php?test=$test[key]&delete=$qus[key]'>Delete</a></td></tr>";
				else
				echo "<tr><td align='center' valign='middle'><input type='hidden' id='qid' name='data[qus][$i][qid]' value='$qus[qid]'><input type='text' id='pos' class='savetxt' name='data[qus][$i][pos]' value='$qus[pos]'></td><td align='left' valign='middle'>$qus[question]</td><td align='left' valign='middle'>$qus[type]</td><td align='left' valign='middle'>$cat[category]</td><td align='left' valign='middle'><a href='mcquestion.php?test=$test[key]&editqus=$qus[key]'>Edit</a> | <a class='confirdel' href='mcquestion.php?test=$test[key]&delete=$qus[key]'>Delete</a></td></tr>";
				}
				$i++;
			}
		}
