...
class SpyropressAdmin {
    ...
    function init() {
        ...
        // envato verification
        $this->is_verified = ( bool )get_option( '_spyropress_envato_verification_' . get_internal_name() );
        $this->is_builder_installed = ( bool )get_option( '_spyropress_builder_installed_' . get_internal_name() );
    ...
    function enqueue_scripts() {
        ...
        $spyropress_params = array(
            'favicon_url' => framework_assets_img() . 'shortcode_icon.png',
            'media_url' => framework_assets_img() . 'media-button.png',
            'dialog_url' => framework_url() . 'shortcodes/dialog.php',
    ...
    function ouput_messages() {
        ...
        if ( ! empty( $this->messages['success'] ) ) {
            echo '<ul class="spyropress-messages spyropress-success">';
        ...
        if ( ! empty( $this->messages['error'] ) ) {
            echo '<ul class="spyropress-messages spyropress-errors">';
