...
@extract($edit);
    ...
    <form action="" method="post" enctype="multipart/form-data" id="myForm">
        ...
        <table cellpadding="3" cellspacing="3" border="0" align="center">
            ...
            <tr>
            	<td align="right" valign="middle">Test instructions :</td>
                <td align="left" valign="middle"><textarea name="instruction" cols="40" rows="6" id="instruction" class="validate[required]"><?php echo $instruction; ?></textarea></td>
            </tr>
            <tr>
            	<td align="right" valign="middle">Test complete message:</td>
                <td align="left" valign="middle"><textarea name="finish" cols="40" rows="6" id="finish" class="validate[required]"><?php echo $finish; ?></textarea></td>
            </tr>
            <tr>
