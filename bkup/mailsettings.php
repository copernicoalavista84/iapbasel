    ...
    <?php
		echo '<tr><th align="center" valign="middle" width="30">#</th><th align="left" valign="middle">Campaign</th><th align="left" valign="middle">Actions</th></tr>';
			...
			while($camp = mysql_fetch_array($camps)){
				if($i>0)
				echo "<tr><td align='center' valign='middle'>$i</td><td align='left' valign='middle'>$camp[subject]</td><td align='left' valign='middle'><a href='mailsettings.php?camid=$camp[camid]'>Edit</a></td></tr>";
				$i++;
			}
    ?>
    </table>
