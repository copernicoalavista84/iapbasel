...
<body style="margin:0 auto;width:1000px;">
 ...
 <?php 
    ...
    ?>
        ...
        <?php
       echo "<TR><th align='center' valign='middle' width='30'>#</th><th align='left' valign='middle'>Category</th><th align='center' valign='middle'>No. of Qs</th><th align='center' valign='middle'>Max. Avg. Score</th><th align='center' valign='middle'>Avg. Score</th><th align='center' valign='middle'>His Avg. Score</th><th align='left' valign='middle'>Process</td></tr>";
        if($uc>0){
			$i = 1;
    while($cag = mysql_fetch_array($cates)){
        ...
        echo "<tr><td align='center' valign='middle'>$i</td><td>$cag[category]</TD><TD align='center'>$rs</TD><TD align='center'>$maxscore</TD><td align='center'>$avgscore</td><td align='center'>$hisscore</td><td align='left'><a href='moredetails.php?test=$test[key]&cate=$cag[key]&user=$tester[key]'>Details.</a></td></TR>";
		$i++;
    }}
