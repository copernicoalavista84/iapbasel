...
<body style="margin:0 auto;width:1000px;">
 ...
 <?php 
    ...
    ?>
        ...
        <?php
       echo "<TR><th align='center' valign='middle' width='30'>#</th><th align='left' valign='middle'>User Name</th><th align='center' valign='middle'>No. of Qs</th><th align='center' valign='middle'>Max. Avg. Score</th><th align='center' valign='middle'>His Avg. Score</th><th align='left' valign='middle'>Process</td></tr>";
        if($uc>0){
			$i = 1;
    while($fer = mysql_fetch_array($tests)){
        ...
        echo "<tr><td align='center' valign='middle'>$i</td><td>$tester[firstname] $tester[lastname]</TD><TD align='center'>$rs</TD><TD align='center'>$test[max]</TD><td align='center'>$score[0]</td><td align='left'>$fer[process] | <a href='details.php?test=$test[key]&user=$tester[key]'>Details.</a></td></TR>";
		$i++;
    }}
