...
<div class="contentcenbg">
    ...
    <?php 
$edit=mysql_fetch_array(mysql_query("select * from users where `uid`='".$user['uid']."'"));
@extract($edit);
	?> 
        <form method="post" action="" id="myForm">
            ...
            <table cellpadding="3" cellspacing="3" border="0" align="center">
                ...
                <tr><td align="right" valign="middle">Password :</td><td align="left" valign="middle"><input type="password" class="validate[required,minSize[6]]" id="password" name="password" value="<?php echo $password; ?>"></td></tr>
