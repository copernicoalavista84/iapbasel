        ...
        echo '<div class="controls">';
            ...
            foreach ( (array) $item['options'] as $choice_value => $choice_label ) {
                ...
                printf(
                    ...
                    $choice_id, spyropress_build_atts( $atts ), esc_attr( $choice_label )
                );
    ...
    echo '<div ' . build_section_class( 'section-radio-img section-full', $item ) . '>';
        ...
        echo '<div class="controls">';
            ...
            foreach ( (array) $item['options'] as $choice_value => $choice ) {
                ...
                printf(
                    '<label class="radio-img%5$s" for="%1$s"><input%2$s /><img src="%4$s" alt="" title="%3$s" /><span>%3$s</span></label>',
                    $choice_id, spyropress_build_atts( $atts ), esc_attr( $choice['title'] ),
