...
function spyropress_widget_editor( $item, $id, $value, $is_builder = false ) {
    ...
    if ( isset( $item['is_shortcode'] ) && $item['is_shortcode'] ) {
        $js .= 'theme_advanced_buttons1:"code",
                theme_advanced_buttons2:"",
                plugins:"inlinepopups,tabfocus,fullscreen,wpfullscreen"';
    }
    else {
        $js .= 'spellchecker_languages:"+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv",
                theme_advanced_buttons1:"bold,italic,underline,strikethrough,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull,|,link,unlink,|,spellchecker,wp_fullscreen,code,wp_adv,|, spyroimage",
                ...
                plugins:"inlinepopups,spellchecker,tabfocus,paste,media,fullscreen,wordpress,wpeditimage,wpgallery,wplink,wpdialogs,-spyroimage,wpfullscreen"';
    }
