...
if ( ! class_exists( 'SpyropressBuilder' ) ) {
    ...
    class SpyropressBuilder {
        ...
        /** Variblaes **********************************************/
        var $enabled_post_types = array( 'page', 'bucket' );
        var $version = '1.0.1';
        ...
        function init() {
            ...
            // Load Templates
            include_once ( 'classes/spyropress-row-templates.php' );
            include_once ( 'classes/spyropress-col-templates.php' );
            ...
            $includes = array(
                ...
                'modules/service-list/service-list.php',
