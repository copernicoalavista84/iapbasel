...
class SpyropressWidgets {
    ...
    function includes() {
        ...
        $widgets = apply_filters( 'spyropress_register_widgets', $widgets );
    ...
    function widget_extras_update( $instance, $new_instance ) {
        ...
        if ( isset( $new_instance['custom_container_id'] ) )
            $instance['custom_container_id'] = $new_instance['custom_container_id'];

        if ( isset( $new_instance['custom_container_class'] ) )
        ...
        if ( isset( $new_instance['custom_slug'] ) )
            $instance['custom_slug'] = $new_instance['custom_slug'];

        if ( isset( $new_instance['suppress_title'] ) )
